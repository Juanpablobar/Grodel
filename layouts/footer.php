<footer>
    <div class="footer-up">
        <div>
            ...
            <h2>Permítanos ayudarlo a ayudarse a sí mismo. Haremos las cosas fáciles y, con suerte, entretenidas.</h2>
            <div class="correo-elec">
                <input type="text" placeholder="Dirección de Correo Electrónico"><button>Regístrate</button>
            </div>
            <span><i class="icofont-facebook"></i></span>
            <span><i class="icofont-twitter"></i></span>
            <span><i class="icofont-instagram"></i></span>
            <span><i class="icofont-youtube-play"></i></span>
        </div>
        <div>
            <div class="footer-item">
                <h1>Apoyo</h1>
                <h3><a href="#">Búsqueda Avanzada</a></h3>
                <h3><a href="#">Ayuda</a></h3>
                <h3><a href="contact">Soporte de correo electrónico</a></h3>
                <h3><a href="contact">Cita</a></h3>
            </div>
            <div class="footer-item">
                <h1>Información</h1>
                <h3><a href="#">Acerca de </a></h3>
                <h3><a href="#">Servicios</a></h3>
                <h3><a href="#">Preguntas frecuentes</a></h3>
                <h3><a href="#">Lista de deseos</a></h3>
            </div>
            <div class="footer-item">
                <h1>Contacto</h1>
                <h3><a href="#">Preguntas frecuentes</a></h3>
                <h3><a href="#">Políticas</a></h3>
                <h3><a href="contact">support@example.com</a></h3>
            </div>
        </div>
    </div>
    <div class="footer-down">
        <div><h3> &copy; <?php echo date('Y'); ?> Grodel | Expertos en Plomería, Todos los derechos reservados</h3></div>
        <div>
            ...
            <li class="icon-payment"><svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" aria-labelledby="pi-diners_club"><title id="pi-diners_club">Diners Club</title><path opacity=".07" d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"/><path fill="#fff" d="M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32"/><path d="M12 12v3.7c0 .3-.2.3-.5.2-1.9-.8-3-3.3-2.3-5.4.4-1.1 1.2-2 2.3-2.4.4-.2.5-.1.5.2V12zm2 0V8.3c0-.3 0-.3.3-.2 2.1.8 3.2 3.3 2.4 5.4-.4 1.1-1.2 2-2.3 2.4-.4.2-.4.1-.4-.2V12zm7.2-7H13c3.8 0 6.8 3.1 6.8 7s-3 7-6.8 7h8.2c3.8 0 6.8-3.1 6.8-7s-3-7-6.8-7z" fill="#3086C8"/></svg></li>
            
            <li class="icon-payment"> <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width="38" height="24" aria-labelledby="pi-discover"><title id="pi-discover">Discover</title><path d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z" fill="#000" opacity=".07"/><path d="M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32" fill="#FFF"/><path d="M37 16.95V21c0 1.1-.9 2-2 2H23.228c7.896-1.815 12.043-4.601 13.772-6.05z" fill="#EDA024"/><path fill="#494949" d="M9 11h20v2H9z"/><path d="M22 12c0 1.7-1.3 3-3 3s-3-1.4-3-3 1.4-3 3-3c1.7 0 3 1.3 3 3z" fill="#EDA024"/></svg></li>
