...
<head>
    ...
    <title> Grodel | <?php echo $_GET['text']; ?></title>
...
<div class="contact">
    <div>
        ...
        <h2><a href="index">Inicio</a> / <?php echo $_GET['text']; ?></h2>
    </div> 
</div>
...
<div class="products">
	...
	<div class="dropdownMenu">
       ...
       <div class="dropdownMenu">
		<div class="title dropdownButton dropdownButton4">
            <h1>Comprar por tamaño<i class="flecha-abajo" id="icofont"></i></h1>
		</div>
	...
	<div class="dropdownMenu">
		<div class="title dropdownButton dropdownButton5">
            <h1>Comprar por precio<i class="flecha-abajo" id="icofont2"></i></h1>
		</div>
	...
	<div class="dropdownMenu">
		<div class="title dropdownButton dropdownButton6">
            <h1>Comprar por marca<i class="flecha-abajo" id="icofont3"></i></h1>
		</div>
	...
	<div class="dropdownMenu">
		<div class="title dropdownButton dropdownButton7">
            <h1>Comprar por tipo<i class="flecha-abajo" id="icofont4"></i></h1>
		</div>
    ...
    <div class="shop">
        <?php
                ...
                $totalProductos = mysqli_fetch_row($totalQuery);
                   ...
                   where 
                   nombre like '%".$_GET['text']."%' or
                   precio like '%".$_GET['text']."%' or
                   tamaño like '%".$_GET['text']."%' or
                   tamaño2 like '%".$_GET['text']."%' or
                   material like '%".$_GET['text']."%' or
                   material2 like '%".$_GET['text']."%' or
                   marca like '%".$_GET['text']."%' or
                   tipo like '%".$_GET['text']."%'
                ...
                <div class="single">
                    ...
                    <a href="shop-single?id=<?php echo $fila['id']; ?>"><figure>
                    <img src="img/<?php echo $fila['img'] ?>" title="<?php echo $fila['nombre'] ?>" alt="<?php echo $fila['nombre'] ?>">
                    <img class="img2" src="img/<?php echo $fila['img'] ?>" title="<?php echo $fila['nombre'] ?>" alt="<?php echo $fila['nombre'] ?>">
                     <div class="single-icons">
                         <a href="shop-single?id=<?php echo $fila['id']; ?>"><span><i class="icofont-search"></i></span></a>
                            <a href="shop-single?id=<?php echo $fila['id']; ?>"><span><i class="icofont-link"></i></span></a>
                    </div>
                    </figure></a>
                    <div class="single-text">
                        <a href="shop-single?id=<?php echo $fila['id']; ?>"><h1><?php echo $fila['nombre']; ?></h1></a>
                        <h2>$<?php echo number_format($fila['precio'],2,'.',''); ?>MX</h2>
                    </div>
